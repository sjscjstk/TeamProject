                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" role="form" action="/board/join" method="POST">
                                ...
                                <div class="form-group">
                                    <input type="submit" class="btn btn-primary btn-user btn-block" onclick="javascript:join_alert()" value="Register Account">
                                </div>

                                <a href="http://localhost:8282/" class="btn btn-primary btn-user btn-block">Main Home</a>
                            </form>
                            <hr>
                        </div>
                    </div>
