...
<html lang="en">
    <head>
	   ...
	   <style>
		...
		function login_afterlog_btn(){
			alert('로그아웃 후 다시 이용해주세요.');
		}
                        ...
                        <div class="text-center text-white">
							...
							<div class="searchbox12">
						      ...
						      <div class="container2">
						        ...
						        <div class="item2">
						          <span class="icon2">＊</span>
						          <span class="name2"><a class="lf" href="./board/list_after">공지사항</a></span>
						        </div>
						
						        <div class="item2">
						          <span class="icon2">＊</span>
						          <span class="name2"><a class="lf" href="./event/board/list_after">이달의 알림</a></span>
						        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="features-icons-item mx-auto mb-0 mb-lg-3">
                            ...
                            <h3><a class="na" href="http://localhost:8282/board/list_after/">대학알림</a></h3>
                ...
                <div class="row">
                    <div class="col-lg-6 h-100 text-center text-lg-start my-auto">
                        <ul class="list-inline mb-2">
                            <li class="list-inline-item"><a class="na2" href="main3">대학홈페이지</a></li>
                            ...
                            <li class="list-inline-item na2">⋅</li>
                            <li class="list-inline-item"><a class="na2" href="http://localhost:8282/board/list_after/">대학알림</a></li>
                        </ul>
