...
<html lang="en">
	...
	<nav>
         ...
         <div class="nav-items">
	         ...
	         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
         	<li><a href="login" onclick="window.open(this.href, '_blank', 'width=450px,height=550px,toolbars=no,scrollbars=no'); return false;">LOGIN</a></li>
         	<li><a href="http://localhost:8282/board/join/">JOIN</a></li>
                       ...
                       <div class="text-center text-white">
						...
						<div class="searchbox12">
					      <div class="header12">
					        ...
					        <input onkeyup="filter()" class="JQKye" type="text" id="value2" placeholder="검색어를 입력하세요.">
					      </div>
					      ...
					      <div class="container2">
						        ...
						        <div class="item2">
						          <span class="icon2">＊</span>
						          <span class="name2"><a class="lf" href="./board/list_before">공지사항</a></span>
						        </div>
						
						        <div class="item2">
						          <span class="icon2">＊</span>
						          <span class="name2"><a class="lf" href="./event/board/list_before">이달의 알림</a></span>
						        </div>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
                            ...
                            <h3><a class="na" href="aiuni">대학소개</a></h3>
                            <p class="lead mb-0">역대총장<br/>총장인사<br/>대학슬로건<br/>캠퍼스투어</p>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
                    ...
                    <div class="col-lg-4">
                        <div class="features-icons-item mx-auto mb-0 mb-lg-3">
                            ...
                            <h3><a class="na" href="http://localhost:8282/board/list_before/">대학알림</a></h3>
                ...
                <div class="row">
                    <div class="col-lg-6 h-100 text-center text-lg-start my-auto">
                        <ul class="list-inline mb-2">
                            ...
                            <li class="list-inline-item na2">⋅</li>
                            <li class="list-inline-item"><a class="na2" href="http://localhost:8282/board/list_before">대학알림</a></li>
                        </ul>
